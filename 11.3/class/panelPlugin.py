...
class panelPlugin:
    ...
    _check_url= 'https://api.bt.sb/api/panel/get_soft_list_status'
    ...
    def __set_pyenv(self, filename):
        ...
        temp_file = temp_file.replace('http://download.bt.cn/install/public.sh', 'http://io.bt.sb/install/public.sh')
        temp_file = temp_file.replace('https://download.bt.cn/install/public.sh', 'http://io.bt.sb/install/public.sh')
        env_path = [
    ...
    def install_sync(self, pluginInfo, get):
        if 'download' in pluginInfo['versions'][0]:
            ...
            public.downloadFile(
                'https://ccc.bt.sb/api/Pluginother/get_file?fname=' +
                pluginInfo['versions'][0]['download'], toFile)
...
`num` INTEGER
    ...
    def get_cloud_list_status(self, get):
        ...
        try:
            ...
            list_body = public.GetJson(public.returnMsg(True,''))
