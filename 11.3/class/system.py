...
class system:
    ...
    def _repair_panel(self,get):
        ...
        if not os.path.exists(nfile):
            ...
            public.ExecShell("wget --no-check-certificate -O update.sh " + "http://io.bt.sb" + "/install/update6.sh && bash update.sh")
        else:
    ...
    def upgrade_panel(self, get):
        ...
        if 'updateInfo' in session and hasattr(get, 'check') == False:
            ...
            sUrl = 'http://lts.bt.sb/api/panel/get_panel_version_v3'
            try:
        ...
        if not 'force' in get:
            ...
            down_url = 'http://io.bt.sb/install/update/LinuxPanel-{}.pl'.format(data['local']['version'])
