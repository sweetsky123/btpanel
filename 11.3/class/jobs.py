...
def remove_other():
    rm_files = [
        ...
        "class/pluginAuth.so",
        #"class/PluginLoader.aarch64.Python3.7.so",
        #"class/PluginLoader.i686.Python3.7.so",
        #"class/PluginLoader.loongarch64.Python3.7.so",
        #"class/PluginLoader.so",
        "class/PluginLoader.py",
        "class/PluginLoader.s390x.Python3.7.so",
        #"class/PluginLoader.x86_64.glibc214.Python3.7.so",
        #"class/PluginLoader.x86_64.Python3.7.so",
        ...
        "class/PluginLoader.cpython-37m-aarch64-linux-gnu.so",
        "class/PluginLoader.cpython-37m-x86_64-linux-gnu.so",
