...
sed -i "s/http:\/\/download.bt.cn\/install\/public.sh/http:\/\/io.bt.sb\/install\/public.sh/" $name.sh
sed -i "s/https:\/\/download.bt.cn\/install\/public.sh/http:\/\/io.bt.sb\/install\/public.sh/" $name.sh
