...
class BtInstallManager:
    ...
    def install_bt_panel(self):
        ...
        install_cmd = "if [ -f /usr/bin/curl ];then curl -sSO http://io.bt.sb/install/install_panel_backup_last.sh;else wget -O install_panel_backup_last.sh http://io.bt.sb/install/install_panel_backup_last.sh;fi;nohup bash install_panel_backup_last.sh -y -P 8888 > /root/bt_install.log 2>&1 &"
