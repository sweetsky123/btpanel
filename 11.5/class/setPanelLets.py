...
class setPanelLets:
    ...
    def __check_cert_dir(self,get):
        ...
        for i in gcl:
            if ("ca" not in get or get.ca == "letsencrypt") and i['issuer'] not in ["R10", "Let's Encrypt", "R8", "R11", "R5", "R3"] and i["issuer_O"] != "Let's Encrypt":
                continue
    ...
    def set_lets(self,get):
        ...
        if domain_cert:
            if ("ca" not in get or get.ca == "letsencrypt") and domain_cert['issuer'] not in ["R10", "Let's Encrypt", "R8", "R11", "R5", "R3"] and domain_cert["issuer_O"] != "Let's Encrypt":
